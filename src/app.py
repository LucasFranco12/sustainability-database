...
def venue_handler():
    #Queries to display all municipalities in county and their installation count
...
def municipality_handler():
    #Query to display total installations
    ...
    #Query to display residential installations
    ...
    #Query to display commercial installations
    ...
    #Query to display other installations
