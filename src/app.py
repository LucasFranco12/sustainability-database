...
def venue_handler():
    ...
    return render_template('my-county-result.html', oldccominstall=oldccominstall, currccominstall=currccominstall, oldinstallations=oldinstallations, currentinstallations=currentinstallations, oldcresinstall=oldcresinstall, currcresinstall=currcresinstall, heads=heads, headres=headres, headcom=headcom)
...
def municipality_handler():
    ...
    return render_template('my-municipality-result.html', oldinstallations=oldinstallations, currentinstallations=currentinstallations, oldresinstall=oldresinstall, curresinstall=curresinstall, heads=heads, headres=headres)
