...
def venue_handler():
    ...
    return render_template('my-county-result.html', oldinstallations=oldinstallations, currentinstallations=currentinstallations, oldcresinstall=oldcresinstall, currcresinstall=currcresinstall, heads=heads, headres=headres)
